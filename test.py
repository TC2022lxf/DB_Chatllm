...
async def generate_responses(generate):
    # 这里假设 generate 是您的异步生成器对象
...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    if request.stream:
        ...
        #return StreamingResponse(generate_responses(generate),media_type='text/event-stream')

        return EventSourceResponse(generate_responses(generate), media_type='text/event-stream')
